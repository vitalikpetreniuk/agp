$(function () {
    ...
    // $( "#amount-max-year" ).val($( "#slider-range-max-year" ).slider( "values", 0));
    ...
    // Єтот скрип работае и все в порядке, если стоит перед скриптами с плагином ползунков, сейчас не работает
    $('input, select').styler();
